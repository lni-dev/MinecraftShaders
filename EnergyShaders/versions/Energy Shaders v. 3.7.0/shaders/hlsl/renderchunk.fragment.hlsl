...
mCave *= 2.0;
mCave = min(1.0, mCave);
vec3 N = calculateSurfaceNormal(PSInput.inChunkPos.xyz);
float shadow = 0.0;
...
diffuse = Ambient(diffuse, PSInput.inScreenPos /*screenPosition*/, shadow, PSInput.uv1.x/*light*/, mTime.w/*nightDay*/, mTime.z/*rain*/, mCave/*darkness*/, N /*Normal*/);
...
diffuse = Fog(diffuse, PSInput.inWorldPos, mTime.w/*nightDay*/, mTime.z/*rain*/, mCave/*darkness*/);
